...
<div id="searchpanel" class="panel-body search-panel">
    <div class="row row-height">
        <div class="col-height col-md-3">
            <label>{{ labels.products_label }}</label>
            <input type="text" v-model="localData.product" class="form-control input-md" maxlength="50" />
        </div>
        <div class="col-height col-md-3">
            <label>{{ labels.nameens_label }}</label>
            <input type="text" v-model="localData.nameen" class="form-control input-md" maxlength="50" />
        </div>
...
const tableSettings = {
    ...
    columns: [
        {name: "product", type: "STRING", sorter: "product", label: "product_headerlabel" },
        {name: "nameen", type: "STRING", sorter: "nameen", label: "nameen_headerlabel" },
        {name: "seqno", type: "STRING", sorter: "seqno", label: "sequence_headerlabel", css: "text-center" }
    ],        
    actions: [
